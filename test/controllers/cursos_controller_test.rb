...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { comuna_id: @curso.comuna_id, fecha_inicio: @curso.fecha_inicio, fecha_termino: @curso.fecha_termino, plan_formativo_id: @curso.plan_formativo_id } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { comuna_id: @curso.comuna_id, fecha_inicio: @curso.fecha_inicio, fecha_termino: @curso.fecha_termino, plan_formativo_id: @curso.plan_formativo_id } }
